...
class FairseqSimulSTAgent(SpeechAgent):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--shift-left-context", action="store_true", default=None, help="Applies shiftable left context",
        )
        parser.add_argument(
            "--shift-right-context", action="store_true", default=False, help="Applies shiftable right context",
        )
        parser.add_argument(
            "--shift-center-context", action="store_true", default=False, help="Applies shiftable center context",
        )
    ...
    def change_model_parameters(self, args, state):
        ...
        if args.shift_center_context is not None:
            state["cfg"]["model"].shift_center_context = args.shift_center_context
